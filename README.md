...
```bash
pip install google-generativeai duckduckgo-search edge-tts vosk nest-asyncio
```
...
2. Ingresar tu API Key de Google Gemini
3. Obtener una API Key gratuita en: https://aistudio.google.com/apikey

### Opciones de Configuración

| Parámetro | Descripción | Valor por defecto |
|-----------|-------------|-------------------|
| API Key de Gemini | Clave API de Google Gemini | (vacío) |
| Modelo de IA | Modelo de IA a utilizar | gemini-2.0-flash |
...
- **Gemini 2.0 Flash Lite** - Más rápido, menor calidad
...
### Python (requeridas)
- `google-generativeai` >= 0.3.0 - Cliente de Google Gemini API
